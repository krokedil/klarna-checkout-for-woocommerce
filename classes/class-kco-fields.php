	...
	public static function fields() {
		$settings = array(
			...
			'add_to_email'               => array(
				...
				'type'     => 'checkbox',
				'label'    => __( 'This will add Kustom\'s Post Purchase information to the order emails that are sent. You can read more about this here: ', 'klarna-checkout-for-woocommerce' ) . '<a href="https://docs.klarna.com/payments/web-payments/additional-resources/ux-guidelines/post-purchase-experience/" target="_blank">Kustom URLs</a>',
				'default'  => 'no',
				'desc_tip' => true,
			),
			'testmode'                   => array(
