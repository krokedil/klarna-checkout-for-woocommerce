...
/**
 * Cart item attributes class.
 *
 * Adds shipping-relevant product data (weight, dimensions, shipping class) to each cart item sent to
 * Kustom, so the TMS can price and route the shipment.
 */
class CartItemAttributes {
	...
	/**
	 * Add the product weight and dimensions to the Kustom item.
	 *
	...
	/**
	 * Add the product's shipping class to the Kustom item.
	 *
	 * @param array $klarna_item The Kustom Item.
	 * @param array $cart_item The Cart Item.
	 * @return array
