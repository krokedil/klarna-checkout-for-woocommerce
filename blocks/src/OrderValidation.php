	...
	private static function submit_wc_order( $klarna_order, $order = null ) {
		...
		$body = array(
			...
			'billing_address'  => array(
				...
				'state'      => kco_get_wc_state_code( $klarna_billing_address['region'] ?? '', $klarna_billing_address['country'] ?? '' ),
			...
			'shipping_address' => array(
				...
				'state'      => kco_get_wc_state_code( $klarna_shipping_address['region'] ?? '', $klarna_shipping_address['country'] ?? '' ),
