 ...
 *
 * @param shippingInIframe - Whether the shipping fields are displayed in the iframe.
 * @returns {string[]} - An array of CSS selectors for elements to hide.
 */
 ...
 *
 * @param toHide - An array of CSS selectors for elements to hide.
 * @returns {void}
 */
 ...
 *
 * @param toShow - An array of CSS selectors for elements to show.
 * @return {void}
 */
 ...
 *
 * @param htmlContent - The HTML content to be added as an iframe.
 * @returns {HTMLDivElement} - The wrapper div containing the iframe.
 */
 ...
 *
 * @param kcoWrapper - The wrapper div containing the Kustom Checkout iframe.
 * @returns {void} - Removes the Kustom Checkout iframe from the WooCommerce checkout page
 */
