<?php
/**
 * Template file for the shipping section of the cart, used for TMS-controlled shipping.
 *
 * Overrides cart/cart-shipping.php.
 *
...
if ( ! empty( $rate ) ) {
	...
	<tr class="woocommerce-shipping-totals shipping">
		...
		<td data-title="<?php esc_html_e( 'Shipping', 'woocommerce' ); ?>" class="kco-shipping"><?php echo wc_cart_totals_shipping_method_label( $rate ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_cart_totals_shipping_method_label() already returns escaped output. ?></td>
	</tr>
