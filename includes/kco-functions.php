...
function kco_wc_prefill_consent() {
	if ( ! kco_wc_prefill_allowed() && is_user_logged_in() ) {
		...
		if ( 'de_DE' === get_locale() || 'de_DE_formal' === get_locale() ) {
			...
			<a href="https://cdn.kustom.co/1.0/shared/content/legal/terms/' . $merchant_id . '/de_de/checkout" target="_blank">https://cdn.kustom.co/1.0/shared/content/legal/terms/' . $merchant_id . '/de_de/checkout</a>';
		} else {
			$button_text = 'Meine Adressdaten vorausfüllen';
			$link_text   = 'Es gelten die Nutzungsbedingungen zur Datenübertragung';
			...
			<a target="_blank" href="https://cdn.kustom.co/1.0/shared/content/legal/terms/' . $merchant_id . '/en_us/checkout">https://cdn.kustom.co/1.0/shared/content/legal/terms/' . $merchant_id . '/en_us/checkout</a>';
		}
		?>
